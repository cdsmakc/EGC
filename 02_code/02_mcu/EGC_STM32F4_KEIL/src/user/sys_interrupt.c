...
VOID __SYS_SystemInterruptInit(VOID)
{
    ...
    CPU_CRITICAL_ENTER();
    apInterruptCallbackTable[SYS_INT_ID_SPI4]     = EGC_LG1_SPIIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_SPI5]     = EGC_LG2_SPIIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_SPI6]     = EGC_CTL_SPIIntHandler ;
    
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH0] = EGC_LG1_SPIDMAIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH1] = EGC_LG1_SPIDMAIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH3] = EGC_LG2_SPIDMAIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH4] = EGC_LG2_SPIDMAIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH5] = EGC_CTL_SPIDMAIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_DMA2_CH6] = EGC_CTL_SPIDMAIntHandler ;

    apInterruptCallbackTable[SYS_INT_ID_EXTI0]    = EGC_MSR_MSA300EXTIIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_I2C1_EV]  = EGC_MSR_I2CIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_USART3]   = EGC_ESP_ESP32UARTIntHandler ;
    apInterruptCallbackTable[SYS_INT_ID_USART1]   = EGC_HST_UARTInterruptHandler ;
    CPU_CRITICAL_EXIT();
